...
namespace Infraestrutura.Compartilhado
{
    public abstract class RepositorioBase<TEntidade> : IRepositorioBase<TEntidade> where TEntidade : LongEntidadeChave, IRaizAgregada
    {
        #region Construtor

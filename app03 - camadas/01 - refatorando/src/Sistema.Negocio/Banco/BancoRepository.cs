...
namespace Sistema.Negocio
{
    ...
    ///      using Dapper;
    /// </summary>
    public class BancoRepository : ConexaoSqlite
    {
        /// <summary>
        ///     contrutor da classe.
        /// </summary>
        //public BancoRepository(string con)
        //{
        ...
        /// </summary>
        public IEnumerable<BancoModel> Listar()
        {
            using var db = ConexaoDB;

            return db.Query<BancoModel>(@"SELECT * FROM fnbanco "); 
        }

        /// <summary>
        ///     listar filtrando os dados da tabela 
        /// </summary>
        public IEnumerable<BancoModel> Listar(int idFiltro, string valor)
        {
            ...
            try
            {
                ...
                //************************************************
                using var db = ConexaoDB;
                return db.Query<BancoModel>(cQryBase, parameter);
        ...
        /// </summary>
        public BancoModel BuscarID(string Codigo)
        {
            using var db = ConexaoDB;
            
            return db.Query<BancoModel>(@"SELECT * FROM fnbanco WHERE Codigo = @pCodigo", new { pCodigo = Codigo }).SingleOrDefault();
        ...
        /// </summary>
        public int Salvar(OperacaoEnum operacao, BancoModel banco)
        {
            try
            {
                using var db = ConexaoDB;

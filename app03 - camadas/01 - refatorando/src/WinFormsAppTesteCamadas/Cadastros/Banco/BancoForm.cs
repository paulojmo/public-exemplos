...
namespace WinFormsApp
{
    ...
    {
        BancoRepository repositorio = new BancoRepository();
        ...
        public PaisForm(OperacaoEnum operacaoEnum, string Codigo)
        {
            ...
            // no Contrutor
            //************************************************
            banco = repositorio.BuscarID(Codigo);
            if (banco == null)
            {
        ...
        private void ConfirmarButton_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                if (operacaoEnum == OperacaoEnum.Exclusao)
                {
                    ...
                    //************************************************
                    resultado = repositorio.Excluir(banco.Codigo);
                }
                else
                {
                    ...
                    // afetados pela operação
                    //************************************************
                    resultado = repositorio.Salvar(operacaoEnum, banco);
                }
